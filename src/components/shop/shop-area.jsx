...
import Recommend from "../products/electronics/recommend";
...
const ShopArea = ({
  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4">
              <div className="tp-shop-sidebar mr-10">
                ...
                />
                {/* status */}
                <StatusFilter setCurrPage={setCurrPage} sizes={sizes} />
                {/* categories */}
                <CategoryFilter
                ...
                {/* brand */}
                <ProductBrand setCurrPage={setCurrPage} brands={brands} />
                {/* reset filter */}
                <ResetButton />
              </div>
            </div>
      ...
      {recommend && recommend.length > 0 && <Recommend products={recommend} />}
    </>
  );
};
